...
entity SysClkWizard_clk_wiz is
  port (
    CLK_6 : out STD_LOGIC;
...
end SysClkWizard_clk_wiz;

architecture STRUCTURE of SysClkWizard_clk_wiz is
...
entity SysClkWizard is
  ...
  attribute NotValidForBitStream of SysClkWizard : entity is true;
end SysClkWizard;

architecture STRUCTURE of SysClkWizard is
begin
inst: entity work.SysClkWizard_clk_wiz
     port map (
      CLK_12 => CLK_12,
      CLK_24 => CLK_24,
      CLK_6 => CLK_6,
