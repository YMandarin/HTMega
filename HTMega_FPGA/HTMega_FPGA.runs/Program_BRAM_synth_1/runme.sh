...
HD_PWD='E:/Diplomarbeit/HTMega/HTMega_FPGA/HTMega_FPGA.runs/Program_BRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Program_BRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Program_BRAM.tcl
