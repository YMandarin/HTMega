...
HD_PWD='E:/Diplomarbeit/HTMega/HTMega_FPGA/HTMega_FPGA.runs/GPREG_IP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPREG_IP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPREG_IP.tcl
