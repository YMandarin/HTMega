...
HD_PWD='E:/Diplomarbeit/HTMega/HTMega_FPGA/HTMega_FPGA.runs/SysClkWizard_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SysClkWizard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SysClkWizard.tcl
