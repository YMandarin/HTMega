...
#
# Generated by export_simulation on Thu Feb 17 10:53:46 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './SysClkWizard.sh' script.

./SysClkWizard.sh -reset_run
...
./SysClkWizard.sh -noclean_files

For more information on the script, please type './SysClkWizard.sh -help'.
