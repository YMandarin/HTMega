...
signal clk_12, clk_24, clk_48, clk_96, clk_locked : std_logic := '0';
...
signal addr_bus_1, addr_bus_2 : std_logic_vector(7 downto 0) := X"00";
...
begin
	...
	Clock : SysClkWizard port map(
		...
		CLK_48 => clk_48, CLK_96 => clk_96, 
		reset => '0', locked => clk_locked
	);

	Decoder : Instruction_Decoder port map(
		clk_12 => clk_12, Reset => program_reset, Start_decoder => start_decoder, 
		...
		Bus_addr_1 => addr_bus_1, Bus_addr_2 => addr_bus_2,
	...
	PM_Loader : Program_Loader port map(
		clk_12 => clk_12, 
		Start => start_program_loader, Finished => start_decoder,
		PM_read => pm_program_read
	);

	Loader : Memory_Loader port map(
		clk_12 => clk_12, Start_execution => start_loader, 
		...
		Immediate => immediate, Address_bus_1 => addr_bus_1, Address_bus_2 => addr_bus_2,
	...
	Writer : Memory_Writer port map(
		...
		Bus_Addr_in => addr_bus_1, RAM_Addr_in => addr_ram, PM_Addr_in => addr_pm,
	...
	GP_Bus : GP_Bus_Master port map(
		clk_12 => clk_12, clk_24 => clk_24, clk_96 => clk_96,
		...
		Pin_LED_out(0) => LED_out(1), Pin_LED_out(3 downto 1) => RgbLED_out, 
	...
	RAM : RAM_Controller port map(
		clk_12 => clk_12, clk_24 => clk_24, clk_48 => clk_48,
		...
		Data_out => ram_data_out, RAM_Address => RAM_Addr(17 downto 0),
	...
	BootLoaderI : BootLoader port map(
		clk_12 => clk_12, active => boot_mode,
	...
	Boot_Controller : Boot_Mode_Controller port map(
		clk_12 => clk_12, Button => Button_in(0),
		Boot_Mode => boot_mode,
