...
signal Timer_A_Value, Timer_B_Value, Micros_High, Micros_Low, 
    Timer_A_Compare, Timer_B_Compare : std_logic_vector (15 downto 0) := X"0000";
signal Timer_A_Top, Timer_B_Top : std_logic_vector (15 downto 0) := X"FFFF";
...
signal Timer_A_reset, Timer_B_reset, Micros_reset, Timer_A_clear, Timer_B_clear : std_logic := '0';
...
begin
Timer_A : Timer_16bit port map(clk_6, Timer_A_Value, 
	Timer_A_Compare, Timer_A_Top, Timer_A_Config(0),Timer_A_Config(1), 
	Timer_A_Config(2), Timer_A_reset, Timer_A_clear, Timer_A_Status(0), Timer_A_Status(1),
	port_timer_A,Timer_A_Config(4 downto 3), Timer_A_Config(7 downto 5));

Timer_B : Timer_16bit port map(clk_6, Timer_B_Value, 
	Timer_B_Compare, Timer_B_Top, Timer_B_Config(0),Timer_B_Config(1), 
	Timer_B_Config(2), Timer_B_reset, Timer_B_clear, Timer_B_Status(0), Timer_B_Status(1),
	out_port => port_timer_B, 
	port_config => Timer_B_Config(4 downto 3), 
	prescaler=>Timer_B_Config(7 downto 5));

Timer_Micros : MicrosCounter port map(clk_6, Micros_reset, 
